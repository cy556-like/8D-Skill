...
### 推荐格式：Markdown 缩进列表（适合 Word/Excel 嵌入）
...
│
├─ Material（料）／Method（法）／Measurement（测）／Environment（环）—— 同样展开
```

### 使用要点

1. **团队共创**：避免单人主观，至少 3-5 个候选原因 / 每个 M
2. **证据支撑**：每个原因标注证据来源（数据/观察/文件）
3. **排除法**：经排查排除的标注"暂排除"
4. **配合 5Why**：鱼骨图找方向，5Why 深挖根因
5. **专业绘制工具**：Mermaid / draw.io / XMind（如需图形化输出）
